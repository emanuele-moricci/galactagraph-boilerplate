 ...
 * TYPE DEFINITIONS
 *
 * The following function is used to merge all the `.graphql` type definitions of the `federation-lang` subgraph
 */
 ...
 *
 * The following function is used to merge all the class resolvers of the `federation-lang` subgraph.
 */
 ...
 *
 * The following function is used to merge all the type definitions and resolvers of the `federation-lang` subgraph.
 *
 ...
 * SCHEMA COMPOSITION
 *
 * The following function is used to compose the `federation-lang` subgraph schema,
