...
module.exports = {
  ...
  actions: (data) => {
    ...
    /**
     * Adds the main Model Class, under 'graphql/schema/Models/<MODEL_NAME>.graphql' and 'graphql/schema/Models/<MODEL_NAME>.model.ts''
    ...
    const actions = [
      ...
      {
        type: "add",
        path: `${modelPath}/${capitalizedModelName}.model.ts`,
